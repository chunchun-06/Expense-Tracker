    ...
    <div id="room">
        <div id="expense">
            ...
            <ul>
                ...
                <li><a href="amtpay.php">Amount pay</a></li>
        ...
        <div id="form">
            <h3>AMOUNT TAKEN</h3>
            <form action="insert2.php" method="post" onsubmit="return check();">
                <label for="date" id="data">Date:</label>
                <input type="date" id="expense-date" name="date" max="<?= date('Y-m-d') ?>" required><br>
                <label for="personname" id="data">Person-Name:</label>
                <input type="text" id="personname" name="personname" required><br>
                <label for="amount" id="data">Amount:</label>
                <input type="number" id="amount" name="amount" required><br>
                <label for="returndate" id="data">Return Date:</label>
